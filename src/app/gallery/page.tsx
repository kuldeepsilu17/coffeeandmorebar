...
export default function GalleryPage() {
  return (
    <div className="bg-[#FBF9F5] min-h-screen">
      ...
      <section className="py-12 sm:py-16 bg-[#1A130E] text-[#FAF8F5]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4 sm:space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#241B14] border border-[#3D2F24] text-xs text-amber-300">
          ...
          <p className="text-xs sm:text-sm md:text-base text-[#B5A496] max-w-xl mx-auto leading-relaxed">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2.5 sm:gap-4">
            ...
            <Link href="/contact" className="btn-secondary w-full sm:w-auto text-sm px-6 py-3 min-h-[44px]">
