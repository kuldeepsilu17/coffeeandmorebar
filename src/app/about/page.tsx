        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-[#FFFFFF] bg-[#1A130E] aspect-[4/3]">
                <Image
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-[#FFFFFF] border border-[#EBE3D7] space-y-3">
                <h3 className="font-heading font-bold text-base text-[#1C1510]">
