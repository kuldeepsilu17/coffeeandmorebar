...
export default function PrivacyPolicyPage() {
  return (
    <div className="bg-[#FBF9F5] min-h-screen py-8 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#B86B35] hover:underline mb-6 sm:mb-8 py-2 min-h-[44px]"
        >
          <ArrowLeft className="w-4 h-4" />
          <span>Back to Home</span>
        </Link>

        <div className="p-5 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl bg-[#FFFFFF] border border-[#EBE3D7] shadow-xs space-y-5 sm:space-y-6 text-xs sm:text-sm text-[#635347] leading-relaxed">
          <div className="flex items-center gap-3 border-b border-[#EBE3D7] pb-4 sm:pb-5">
            <div className="p-2.5 sm:p-3 rounded-2xl bg-[#F5EFE6] text-[#B86B35] shrink-0">
          ...
          <h2 className="font-heading font-bold text-base sm:text-lg text-[#1C1510] pt-2 sm:pt-4">
