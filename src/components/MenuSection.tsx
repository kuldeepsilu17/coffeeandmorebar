...
export default function MenuSection({ limit }: { limit?: number }) {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#FFFFFF]" id="menu">
          ...
          {displayedItems.map((item) => (
            <div
              ...
              className={`p-6 rounded-2xl border transition-all duration-300 flex flex-col justify-between ${
                item.highlight
                  ? 'bg-gradient-to-br from-[#FFFFFF] to-[#FDFBF7] border-[#B86B35]/40 shadow-md hover:shadow-xl hover:border-[#B86B35]'
            ...
            >
              <div>
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="p-2 rounded-xl bg-[#F5EFE6] border border-[#EBE3D7] shrink-0">
                    {getCategoryIcon(item.category)}
                  </div>
                  {item.badge && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-[#B86B35]/10 text-[#B86B35] border border-[#B86B35]/20">
                ...
                <h3 className="font-heading font-bold text-lg text-[#1C1510] mb-2">
                  {item.name}
                </h3>
              ...
              <div className="pt-5 mt-4 border-t border-[#F5EFE6] flex items-center justify-between">
                <span className="text-xs font-semibold text-[#8F7D70] uppercase tracking-wider">
                ...
                <a
                  ...
                  className="text-xs font-semibold text-[#B86B35] hover:text-[#9E5624] inline-flex items-center gap-1 group"
                >
